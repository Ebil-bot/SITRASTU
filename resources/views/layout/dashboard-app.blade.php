...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar Brand-->
            <div class="navbar-brand mt-2 ps-3">
                <a class="navbar-brand" href=""><h5>SITRASTU <br> UNIBA MADURA</h5></a>
            </div>
            <!-- Navbar Search-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="/logout/register">Signup</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="/profil/alumni">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Tabel Profil Alumni
                            </a>
...
<div class="container-fluid px-4">
    <div class="text-muted text-center">Copyright &copy; 2025 | Design and Developed by  ebilrap</div>
</div>
    </footer>
    </div>
